...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* spiHandle)
{
  ...
  /* USER CODE END SPI1_MspDeInit 0 */
    ...
    PA7     ------> SPI1_MOSI
    */
    HAL_GPIO_DeInit(GPIOA, L9963T_L_SCK_Pin|L9963T_L_MISO_SDO_Pin|L9963T_L_MOSI_SDI_Pin);
  ...
  /* USER CODE END SPI2_MspDeInit 0 */
    ...
    PB10     ------> SPI2_SCK
    */
    HAL_GPIO_DeInit(GPIOC, L9963T_H_MISO_SDO_Pin|L9963T_H_MOSI_SDI_Pin);

    HAL_GPIO_DeInit(L9963T_H_SCK_GPIO_Port, L9963T_H_SCK_Pin);
